...
use seishin_render::RenderError;

#[derive(Debug)]
pub enum DesktopRuntimeError {
    Engine(seishin_core::EngineError),
    Render(RenderError),
...
impl From<seishin_core::EngineError> for DesktopRuntimeError {
    fn from(value: seishin_core::EngineError) -> Self {
        Self::Engine(value)
    }
}
